									...
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											<div class="form-group">
												...
												<div class="col-md-9">
													<select class="table-group-action-input form-control input-medium" id="manage_id" name="manage_id">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">疫苗信息</label>
												<div class="col-md-9">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" id="breeds" name="breeds" class="form-control" placeholder="请输入内容" value=""/>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" id="others" name="others" class="form-control" placeholder="请输入内容" value=""/>
												</div>
											</div>
											<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/manage/file/manage_add.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->
