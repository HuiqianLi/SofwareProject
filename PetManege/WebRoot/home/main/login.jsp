		...
		<div class="content">
			...
			<form class="login-form" method="post">
				...
				<div class="form-actions">
					<button type="button" id="login_in_button" name="login_in_button" class="btn green">
			...
			<form class="register-form"  action="../../user_login_servlet_action?action=add_record" method="post">
				...
				<div class="form-group">
					...
					<input class="form-control placeholder-no-fix" type="text" placeholder="请输入你的邮箱，忘记密码时系统可凭邮箱恢复密码" id="email" name="email" />
				</div>
				...
				<div class="form-actions">
					...
					<!--button type="button" id="register_in_button" name="register_in_button" class="btn green"-->
					<button type="button" id="register_in_button" class="btn btn-success uppercase pull-right">
						提交
					</button>
				</div>
			</form>
